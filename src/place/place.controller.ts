...
export class PlaceController {
  ...
  @ApiBody({
    description:
      'Formulário com dados opcionais do local a serem atualizados. Se enviar imagens, elas substituirão as anteriores.',
    schema: {
      type: 'object',
      properties: {
        ...
        images: {
          ...
          description:
            'Novas imagens que substituirão as anteriores (máximo de 3)',
        },
      },
    },
  })
